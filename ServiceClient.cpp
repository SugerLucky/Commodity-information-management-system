...
ServiceClient::ServiceClient(const string& name, const string& pwd) {
	client.setUsername(name);
	client.setPassword(pwd);
}

void ServiceClient::purchase(const string& username, int id, int num) {
	Order newOrder;
...
void ServiceClient::browseOrder() {
